...
def load_experiments(myDir, n_cycles_file):
    ...
    for fileName in myFiles:
        ...
        if len(Q_gross_exp) == 0:
            M_diesel_init = cycleData[0, 0]
            M_NH3_init = cycleData[0, 1]
            M_air_init = cycleData[0, 2]
    ...
    return M_diesel_init, M_NH3_init, M_air_init, m_diesel_exp, m_NH3_exp, m_air_exp, Q_gross_exp, CA50_exp, DI_SOI_exp
